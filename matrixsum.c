...
pthread_mutex_t maxCheck;
pthread_mutex_t minCheck;
pthread_mutex_t sumCheck;
...
void *Worker(void *arg) {
  long myid = (long) arg;
  int total, i, j, first, last, max, min, maxX, maxY, minX, minY, value;
